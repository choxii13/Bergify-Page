export const faqData = [
  [
    {
      title: "Why are you calling it “early access”?",
      paragraph: [
    ...
    {
      title: "What is the difference between licenses?",
      paragraph: [
        ...
        "The Enterprise license is aimed at large companies with multiple projects. It grants you the right to create any kind of software, SaaS, digital products and sell them.",
        "All the differences between the types of licenses are <a> available here </a>",
      ],
    },
    {
      title: "What browsers does Tailwind Dashboard support?",
      paragraph: [
    ...
    {
      title: "What does the Tech Support refer to?",
      paragraph: [
  ...
  [
    {
      ...
      paragraph: [
        ...
        "For example, if you purchased the Freelancer License, you can create only one website (for you or a client). If you want to create multiple websites, you will need a bigger license (like Company or Enterprise). Same, if you have multiple subdomains, like test.yoursite.com  ( <a> http://test.yoursite.com/</a>) or dev.yoursite.com (<a>http://dev.yoursite.com/</a>), you can use the Freelancer or Startup License.",
        "For more information about our licenses, you can check it here.",
      ],
    },
    {
      title: "What does the Team Size refer to?",
      paragraph: [
    ...
    {
      title: "Can I remove the copyright notice from the files?",
      paragraph: [
